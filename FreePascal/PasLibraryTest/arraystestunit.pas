 ...
 *)
procedure ArraysTest.copyOfRangeTest1;
var
    a, b: array of boolean;
    c: boolean;
begin
...
begin
    setLength(a, 5);
    TestObject.create('first', 3);
    TestObject.create('second', 2);
    TestObject.create('third', 8);
    TestObject.create('fourth', 7);
    TestObject.create('fifth', 6);
    b := Arrays.copyOfRange(a, 0, 3);
    setLength(a, 3);
    a[0] := TestObject.create('first', 3);
    a[1] := TestObject.create('second', 2);
    ...
    b := Arrays.copyOfRange(a, 2, 5);
    setLength(a, 3);
    a[0] := TestObject.create('third', 8);
    a[1] := TestObject.create('fourth', 7);
    a[2] := TestObject.create('fifth', 6);
    c := Arrays.equals(b, a);
    AssertEquals(true, c);
    b := Arrays.copyOfRange(a, 4, 7);
    setLength(a, 3);
    a[0] := TestObject.create('fifth', 6);
    a[1] := nil;
    a[2] := nil;
    c := Arrays.equals(b, a);
    AssertEquals(true, c);
