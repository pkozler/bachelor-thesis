 ...
 *)
procedure StringTest.stringTest1;
var
    a: String_;
begin
    // a ansiString with whitespaces
    a := String_.create('This is a test.');
    AssertEquals('This is a test.', a.strProperty);
    // letters
    a := String_.create('test');
    AssertEquals('test', a.strProperty);
    // digits
    a := String_.create('1234');
