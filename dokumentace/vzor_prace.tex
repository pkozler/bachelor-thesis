...
\chapter{Diagram případů užití aplikace}\label{sec:uc-diagram}
...
\chapter{Příklad kódu datových XML souborů}\label{sec:xml-structure}
...
\lstset{
    ...
    emph={lists,languages,classes, language, class},emphstyle={\color{blue}}}
    \lstinputlisting{main.xml}

\lstset{
    language=xml,
    tabsize=3,
    frame=lines,
    caption=XML soubor knihovnen,
    label=code:sample,
    frame=shadowbox,
    rulesepcolor=\color{gray},
    xleftmargin=20pt,
    ...
    showstringspaces=false,
    basicstyle=\footnotesize,
    emph={codes, code},emphstyle={\color{blue}}}
    \lstinputlisting{code.xml}
