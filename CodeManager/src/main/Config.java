...
public final class Config {
    ...
    public static final String WINDOW_FXML_DOCUMENT = "/main/gui/fxml/Window.fxml";
    /** path to the class for application data management (application back-end) */
    public static final String CODE_MANAGER_CLASS = "main.app.xml.XmlManager";
    ...
    public static final String XML_STRINGS_BUNDLE = "main.gui.strings.xml.XmlStrings";
    /** path to the strings resource bundle */
    public static final String STRINGS_BUNDLE = "main.gui.strings.Strings";
