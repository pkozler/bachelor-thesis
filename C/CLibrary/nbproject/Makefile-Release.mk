...
${OBJECTDIR}/ArrayList.o: ArrayList.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArrayList.o ArrayList.c

${OBJECTDIR}/Arrays.o: Arrays.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrays.o Arrays.c

${OBJECTDIR}/Boolean.o: Boolean.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Boolean.o Boolean.c

${OBJECTDIR}/Byte.o: Byte.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Byte.o Byte.c

${OBJECTDIR}/Character.o: Character.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Character.o Character.c

${OBJECTDIR}/Collections.o: Collections.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Collections.o Collections.c

${OBJECTDIR}/Double.o: Double.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Double.o Double.c

${OBJECTDIR}/Float.o: Float.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Float.o Float.c

${OBJECTDIR}/Integer.o: Integer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Integer.o Integer.c

${OBJECTDIR}/LinkedList.o: LinkedList.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinkedList.o LinkedList.c

${OBJECTDIR}/List.o: List.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/List.o List.c

${OBJECTDIR}/Long.o: Long.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Long.o Long.c

${OBJECTDIR}/Math_.o: Math_.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Math_.o Math_.c

${OBJECTDIR}/Scanner.o: Scanner.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scanner.o Scanner.c

${OBJECTDIR}/Short.o: Short.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Short.o Short.c

${OBJECTDIR}/String.o: String.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/String.o String.c

${OBJECTDIR}/StringBuilder.o: StringBuilder.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringBuilder.o StringBuilder.c

${OBJECTDIR}/StringTokenizer.o: StringTokenizer.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringTokenizer.o StringTokenizer.c

${OBJECTDIR}/System.o: System.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/System.o System.c

${OBJECTDIR}/TestObject.o: TestObject.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestObject.o TestObject.c

${OBJECTDIR}/main.o: main.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.c

${OBJECTDIR}/test.o: test.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test.o test.c
...
${TESTDIR}/tests/ArrayListTest.o: tests/ArrayListTest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ArrayListTest.o tests/ArrayListTest.c


${TESTDIR}/tests/ArraysTest.o: tests/ArraysTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ArraysTest.o tests/ArraysTest.c


${TESTDIR}/tests/BooleanTest.o: tests/BooleanTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/BooleanTest.o tests/BooleanTest.c


${TESTDIR}/tests/ByteTest.o: tests/ByteTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ByteTest.o tests/ByteTest.c


${TESTDIR}/tests/CharacterTest.o: tests/CharacterTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CharacterTest.o tests/CharacterTest.c


${TESTDIR}/tests/CollectionsTest.o: tests/CollectionsTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CollectionsTest.o tests/CollectionsTest.c


${TESTDIR}/tests/DoubleTest.o: tests/DoubleTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DoubleTest.o tests/DoubleTest.c


${TESTDIR}/tests/FloatTest.o: tests/FloatTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/FloatTest.o tests/FloatTest.c


${TESTDIR}/tests/IntegerTest.o: tests/IntegerTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/IntegerTest.o tests/IntegerTest.c


${TESTDIR}/tests/LinkedListTest.o: tests/LinkedListTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LinkedListTest.o tests/LinkedListTest.c


${TESTDIR}/tests/LongTest.o: tests/LongTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LongTest.o tests/LongTest.c


${TESTDIR}/tests/MathTest.o: tests/MathTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/MathTest.o tests/MathTest.c


${TESTDIR}/tests/ShortTest.o: tests/ShortTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ShortTest.o tests/ShortTest.c


${TESTDIR}/tests/StringBuilderTest.o: tests/StringBuilderTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringBuilderTest.o tests/StringBuilderTest.c


${TESTDIR}/tests/StringTest.o: tests/StringTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringTest.o tests/StringTest.c


${TESTDIR}/tests/StringTokenizerTest.o: tests/StringTokenizerTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/StringTokenizerTest.o tests/StringTokenizerTest.c
...
${OBJECTDIR}/ArrayList_nomain.o: ${OBJECTDIR}/ArrayList.o ArrayList.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArrayList_nomain.o ArrayList.c;\
	else  \
...
${OBJECTDIR}/Arrays_nomain.o: ${OBJECTDIR}/Arrays.o Arrays.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrays_nomain.o Arrays.c;\
	else  \
...
${OBJECTDIR}/Boolean_nomain.o: ${OBJECTDIR}/Boolean.o Boolean.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Boolean_nomain.o Boolean.c;\
	else  \
...
${OBJECTDIR}/Byte_nomain.o: ${OBJECTDIR}/Byte.o Byte.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Byte_nomain.o Byte.c;\
	else  \
...
${OBJECTDIR}/Character_nomain.o: ${OBJECTDIR}/Character.o Character.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Character_nomain.o Character.c;\
	else  \
...
${OBJECTDIR}/Collections_nomain.o: ${OBJECTDIR}/Collections.o Collections.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Collections_nomain.o Collections.c;\
	else  \
...
${OBJECTDIR}/Double_nomain.o: ${OBJECTDIR}/Double.o Double.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Double_nomain.o Double.c;\
	else  \
...
${OBJECTDIR}/Float_nomain.o: ${OBJECTDIR}/Float.o Float.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Float_nomain.o Float.c;\
	else  \
...
${OBJECTDIR}/Integer_nomain.o: ${OBJECTDIR}/Integer.o Integer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Integer_nomain.o Integer.c;\
	else  \
...
${OBJECTDIR}/LinkedList_nomain.o: ${OBJECTDIR}/LinkedList.o LinkedList.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LinkedList_nomain.o LinkedList.c;\
	else  \
...
${OBJECTDIR}/List_nomain.o: ${OBJECTDIR}/List.o List.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/List_nomain.o List.c;\
	else  \
...
${OBJECTDIR}/Long_nomain.o: ${OBJECTDIR}/Long.o Long.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Long_nomain.o Long.c;\
	else  \
...
${OBJECTDIR}/Math__nomain.o: ${OBJECTDIR}/Math_.o Math_.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Math__nomain.o Math_.c;\
	else  \
...
${OBJECTDIR}/Scanner_nomain.o: ${OBJECTDIR}/Scanner.o Scanner.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Scanner_nomain.o Scanner.c;\
	else  \
...
${OBJECTDIR}/Short_nomain.o: ${OBJECTDIR}/Short.o Short.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Short_nomain.o Short.c;\
	else  \
...
${OBJECTDIR}/String_nomain.o: ${OBJECTDIR}/String.o String.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/String_nomain.o String.c;\
	else  \
...
${OBJECTDIR}/StringBuilder_nomain.o: ${OBJECTDIR}/StringBuilder.o StringBuilder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringBuilder_nomain.o StringBuilder.c;\
	else  \
...
${OBJECTDIR}/StringTokenizer_nomain.o: ${OBJECTDIR}/StringTokenizer.o StringTokenizer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StringTokenizer_nomain.o StringTokenizer.c;\
	else  \
...
${OBJECTDIR}/System_nomain.o: ${OBJECTDIR}/System.o System.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/System_nomain.o System.c;\
	else  \
...
${OBJECTDIR}/TestObject_nomain.o: ${OBJECTDIR}/TestObject.o TestObject.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestObject_nomain.o TestObject.c;\
	else  \
...
${OBJECTDIR}/main_nomain.o: ${OBJECTDIR}/main.o main.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main_nomain.o main.c;\
	else  \
...
${OBJECTDIR}/test_nomain.o: ${OBJECTDIR}/test.o test.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -I. -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/test_nomain.o test.c;\
	else  \
